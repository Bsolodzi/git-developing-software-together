...
This means that git will ignore the file and any change you made until you *add* it to the repo.
...
For that we **push** the commits to the remote repository and then, the two repos are "up to date".

Later, a team mate makes a change to a file in their local repo and push it to the remote repository.
...
If you follow the [pre-workshop instructions](preparation.html), RStudio, git, and GitHub are definitely talking to each other.
...
When that happen the changes you made will apear in the repo.
