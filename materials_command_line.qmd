...
1.  Go to [github.com/paocorrales/ringtone_maker](https://github.com/paocorrales/ringtone_maker) and copy the url to the repo, you'll need it to fork the repo.
2. Go to the directory you want to save the new repository.
2.  On the Terminal run: ` gh repo fork https://github.com/paocorrales/ringtone_maker.git`
...
✓ Cloned fork
! Repository paocorrales/ringtone_maker set as the default repository. To learn more about the default repository, run: gh repo set-default --help`
```
...
2.  Change the value of the first 2 variables in the script:
